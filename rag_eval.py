...
def load_vector_db():
    ...
    if os.path.exists(DB_FILE):
        return FAISS.load_local(DB_FILE, client, allow_dangerous_deserialization=True)
    else:
